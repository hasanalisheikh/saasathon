...
2. Add them to the end of your Wrangler file.  
   * [  wrangler.jsonc ](#tab-panel-5641)  
   * [  wrangler.toml ](#tab-panel-5642)  
JSONC  
```  
{  
  "d1_databases": [  
