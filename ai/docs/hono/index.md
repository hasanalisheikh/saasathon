...
See [more benchmarks](./concepts/benchmarks.md).
...
See [more information about routes](./concepts/routers.md).
...
See [more information about Web Standards](./concepts/web-standard.md).
...
- [Basic Authentication](./middleware/basic-auth.md)
- [Bearer Authentication](./middleware/bearer-auth.md)
- [Body Limit](./middleware/body-limit.md)
- [Cache](./middleware/cache.md)
- [Compress](./middleware/compress.md)
- [Context Storage](./middleware/context-storage.md)
- [Cookie](./helpers/cookie.md)
...
- [Language](./middleware/language.md)
- [Pretty JSON](./middleware/pretty-json.md)
- [Secure Headers](./middleware/secure-headers.md)
- [SSG](./helpers/ssg.md)
...
See [more information about Middleware](./concepts/middleware.md).
...
See [Hono Stacks](./concepts/stacks.md).
