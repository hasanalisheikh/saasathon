    ...
    <main className="relative min-h-screen overflow-hidden bg-[#020202] px-4 py-12 text-[#fafafa]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-6rem)] w-full max-w-sm flex-col justify-center">
        ...
        <div className="rounded-lg border border-white/10 bg-[#111111]/95 p-7 shadow-[0_30px_90px_rgba(0,0,0,0.34)] backdrop-blur">
          ...
          {isUnconfirmed && (
            <div className="mt-5 rounded-md border border-[#171717]/30 bg-[#f5f5f5]/60 p-3">
              ...
              <form action={resendVerificationAction} className="mt-2">
                ...
                <button
                  type="submit"
                  className="text-xs font-medium text-[#171717] underline-offset-2 hover:underline"
                >
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs text-[#737373] transition hover:text-[#e5e5e5]"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="mt-5 text-center text-sm text-[#737373]">
            New to Monad?{' '}
            <Link className="font-medium text-[#e5e5e5] transition hover:text-white" href="/signup">
              Sign up
            </Link>
          </p>
        </div>
